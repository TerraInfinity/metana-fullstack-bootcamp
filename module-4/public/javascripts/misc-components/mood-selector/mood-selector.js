...
//Imports
import { MoodTaskService } from '/javascripts/misc-components/mood-selector/mood-task-service.js';
import { systemTaskManager } from '/javascripts/main.js';
import { currentWeather } from '/javascripts/misc-components/weather/weather.js';
...
async function fetchMoodSelector() {
    try {
        ...
        const response = await fetch('/templates/misc-components/mood-selector.hbs');
        if (!response.ok) {
